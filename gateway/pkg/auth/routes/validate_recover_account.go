...
func (route *AuthRoutes) ValidateRecoverAccount(rw http.ResponseWriter, r *http.Request) {
	...
	res, err := route.client.ValidateRecoverAccount(r.Context(), &pb.ValidateRecoverAccountParams{
		Token: token,
	})
